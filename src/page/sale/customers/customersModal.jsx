    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          >
            <Input placeholder={t('customerName')} size="large" />
          </Form.Item>
        ...
        {/* المعلومات الإضافية */}
        <div className="mb-4">
          <h4 className="text-base font-semibold text-blue-600 mb-3">{t('info.customers.customerInfo')}</h4>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Form.Item name="debitLimit" label={t('customerCreditLimit')}>
              <InputNumber
                className="w-full"
                min={0}
                step={0.01}
                placeholder={t('customerCreditLimit')}
